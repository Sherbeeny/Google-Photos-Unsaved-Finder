...
// Also mock the 'unsafeWindow' object that userscripts use to access the page's window object.
// In a real Tampermonkey environment, this is provided automatically. In our test, we can create it.
