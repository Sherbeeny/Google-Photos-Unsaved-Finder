...
(function() {
    ...
    function getPolicy() {
        ...
        if (window.trustedTypes) {
            ...
            // Fallback for browsers or environments without Trusted Types support.
            _policy = {
                createHTML: (string) => string,
            };
        }
    ...
    async function loadAlbumData(sourceContainer, destSelect) {
        ...
        try {
            ...
            selectAllContainer.className = 'gpf-checklist-item';
            ...
            albums.forEach(album => {
                ...
                checkboxContainer.className = 'gpf-checklist-item';
